...
<head>
	...
	<title>Employee Profile | Voyager Compass</title>
...
<h2>Employee Profile</h2><%-- Page heading goes here --%>
...
<c:if test="${pptId > 0}">
	<a class="dark-link" href="/common/ViewPassport.jsp?empId=${profile.getEmpid()}">View Passport</a>
</c:if>
</div>
