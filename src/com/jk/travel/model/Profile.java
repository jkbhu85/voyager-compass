...
public class Profile {
	...
	public Part getProfileImgPart() {
		return profileImgPart;
	}


	public void setProfileImgPart(Part profileImgPart) {
		this.profileImgPart = profileImgPart;
	}
