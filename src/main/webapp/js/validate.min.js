 ...
 */
(function(r,t,l){var u={required:"The <i>%s</i> field is required.",matches:"The <i>%s</i> field does not match the <i>%s</i> field.","default":"The <i>%s</i> field is still set to default, please change.",valid_email:"The <i>%s</i> field must contain a valid email address.",valid_emails:"The <i>%s</i> field must contain all valid email addresses.",min_length:"The <i>%s</i> field must be at least <i>%s</i> characters in length.",max_length:"The <i>%s</i> field must not exceed <i>%s</i> characters in length.",exact_length:"The <i>%s</i> field must be exactly <i>%s</i> characters in length.",
greater_than:"The <i>%s</i> field must contain a number greater than <i>%s</i>.",less_than:"The <i>%s</i> field must contain a number less than <i>%s</i>.",alpha:"The <i>%s</i> field must only contain alphabetical characters.",alpha_numeric:"The <i>%s</i> field must only contain alpha-numeric characters.",alpha_dash:"The <i>%s</i> field must only contain alpha-numeric characters, underscores, and dashes.",numeric:"The <i>%s</i> field must contain only numbers.",integer:"The <i>%s</i> field must contain an integer.",decimal:"The <i>%s</i> field must contain a decimal number.",
is_natural:"The <i>%s</i> field must contain only positive numbers.",is_natural_no_zero:"The <i>%s</i> field must contain a number greater than zero.",valid_ip:"The <i>%s</i> field must contain a valid IP.",valid_base64:"The <i>%s</i> field must contain a base64 string.",valid_credit_card:"The <i>%s</i> field must contain a valid credit card number.",is_file_type:"The <i>%s</i> field must contain only <i>%s</i> files.",valid_url:"The <i>%s</i> field must contain a valid URL.",greater_than_date:"The <i>%s</i> field must contain a more recent date than <i>%s</i>.",less_than_date:"The <i>%s</i> field must contain an older date than <i>%s</i>.",
greater_than_or_equal_date:"The <i>%s</i> field must contain a date that's at least as recent as <i>%s</i>.",less_than_or_equal_date:"The <i>%s</i> field must contain a date that's <i>%s</i> or older."},v=function(a){},w=/^(.+?)\[(.+)\]$/,g=/^[0-9]+$/,x=/^\-?[0-9]+$/,m=/^\-?[0-9]*\.?[0-9]+$/,q=/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,y=/^[a-z]+$/i,z=/^[a-z0-9]+$/i,A=/^[a-z0-9_\-]+$/i,B=/^[0-9]+$/i,C=/^[1-9][0-9]*$/i,D=/^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i,
